...
The Exulu IMP GraphQL API provides programmatic access to manage agents, contexts, workflows, evaluations, and all other platform resources. The schema is **automatically generated** based on your ExuluContext and ExuluAgent instances, providing both core types and dynamic types tailored to your implementation.

<CardGroup cols={3}>
  <Card title="Dynamic schema" icon="wand-magic-sparkles">
    Types are generated from your ExuluContext and ExuluAgent definitions
  </Card>
