...
| `EXULU_KEEP_NODE_LIBLZMA` | `false` | Keep the optional `node-liblzma` package (LGPL-3.0), which the postinstall hook otherwise removes. Enables `xz` compression inside the skill sandbox. |
