...
|---|---|---|---|
| `APP_NAME` | No | Application name shown in the browser tab and used as the PWA `name` and `short_name` in the web manifest. Default: `IMP`. Read only by the manifest route at request time. See [Branding](/self-hosting/branding). | `Acme Agents` |
