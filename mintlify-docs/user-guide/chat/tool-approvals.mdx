...
<Note>
Tools that need an account or credentials never show an approval card — they instead prompt you for a connection via a credential card. See [Connecting tools](/user-guide/chat/connecting-tools) for how that flow works.
</Note>
