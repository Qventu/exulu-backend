...
| **Processing** | Jobs currently queued or transcribing. If any failed, the heading reads "Processing & failed". Jobs stuck in Processing recover automatically — no action needed. |
