...
| `max_steps` | `number` | `0` | Maximum number of knowledge searches allowed per agent turn. `0` = no search-specific cap (the agent's overall tool-step budget still applies). |
