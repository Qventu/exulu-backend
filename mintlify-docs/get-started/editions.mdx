...
| **Agentic retrieval** — multi-phase retrieval pipeline: routing, search, and rerank ([knowledge search](/building/agents/knowledge-search)) (`agentic-retrieval`) | — | <EditionBadge edition="ee" /> |
...
Contact your IMP provider to request an Enterprise license. Licenses are per deployment; the key must match the environment it is issued for.
